...
const ResetPasswordScreen = () => {
  ...
  const handleResetPassword = () => {
    Alert.alert('Email enviado', 'Verifique seu e-mail para redefinir sua senha.');
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.topContainer}>
        ...
        <Text style={styles.subtitle}>Digite o e-mail associado à sua conta para redefinir sua senha.</Text>
